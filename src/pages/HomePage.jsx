...
const HomePage = () => {
  ...
  function checkPokemonValue(event){
    event.preventDefault()
    if(selectedPokemon === null){
        alert("Gabisa Lanjut Bos, Pilih Sek!")
    }else{
        navigate('/detail', {state: {pokemonName: selectedPokemon.name, pokemonUrl: selectedPokemon.url}})
    }
  }
  console.log(selectedPokemon)

// Variabel untuk pindah halaman
      ...
      <div className="container pt-10">
        ...
        {isSubmit === false ? null :(
          <div className="pt-10 flex justify-center items-center gap-2">
            ...
            <button className="px-3 py-2 text-white bg-green-600 rounded-md" onClick={(checkPokemonValue)}>Continue</button>
          </div>
        )}
      </div>
    </>
